...
const el = {
    ...
    //Έργο: NetCalc
    netcalcname: "NetCalc",
    netcalcprojectbtngreen: "Διαβάστε περισσότερα",
    netcalcdesc: "Εφαρμογή ιστού και γραμμής εντολών για τον υπολογισμό παραμέτρων IP δικτύων (διεύθυνση δικτύου, broadcast, διαθέσιμοι κεντρικοί υπολογιστές κ.λπ.). Επιτρέπει την εξαγωγή αποτελεσμάτων σε JSON και έχει σχεδιαστεί για φοιτητές και επαγγελματίες δικτύων.",
