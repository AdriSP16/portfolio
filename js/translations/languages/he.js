...
const he = {
    ...
    //פרויקט: NetCalc
    netcalcname: "NetCalc",
    netcalcprojectbtngreen: "קרא עוד",
    netcalcdesc: "יישום אינטרנט וקו פקודה לחישוב פרמטרים של רשתות IP (כתובת רשת, שידור, מארחים זמינים וכו'). מאפשר ייצוא תוצאות ל-JSON ומיועד לסטודנטים ואנשי מקצוע בתחום הרשתות.",
    ...
    // הסמכת סיסקו: יסודות הרשת
    networkingbasicsTitle: "מונחים בסיסיים ברשתות",
    networkingbasicsCenter: "<b>מרכז:</b> Cisco Networking Academy",
    networkingbasicsDate: "<b>תאריך:</b> אפריל 2025",
    networkingbasicsDescription: "<b>תיאור:</b> הסמכה ביסודות הרשת, המתמקדת בעיקרון הבסיסי של קישוריות, סוגי רשתות, מודלים OSI ו-TCP/IP, כתובת IP, תתי-רשתות ותפקוד של מכשירים כמו סוויצ'ים ורוטרים. מבוא לפרקטיקות טובות בתחום אבטחת הרשתות ולפתרון בעיות נפוצות.",
    networkingbasicsSkills: [
        "מונחים בסיסיים ברשתות ובקישוריות",
        "מודלים OSI ו-TCP/IP",
        "כתובת IP ותתי-רשתות",
        "תפקוד של סוויצ'ים ורוטרים",
        "תפקוד של סוויצ'ים ורוטרים",
        "זיהוי ופתרון בעיות בסיסיות",
        "עקרונות בסיסיים לאבטחת רשתות",
    ],
